...
{
    public partial class ReporteVentasInterfaz : Form
    {
        public ReporteVentasInterfaz()
        {
            InitializeComponent();
        }
        ProductoBSS productosBss = new ProductoBSS(); // P
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            DataTable resultados = productosBss.FiltrarProductosMasVendidos(fechaInicio, fechaFin);
            dataGridView1.DataSource = resultados;
        }

        private void ReporteVentasInterfaz_Load(object sender, EventArgs e)
        {
